...
class ViewController: UIViewController {
    ...
    lazy var currentTheme = themes.randomElement()!
    let themes : [(name : String , emoji : [String] , backColorCard : UIColor, frontColorCard : UIColor)] =
    ...
    lazy var emojiChoices = currentTheme.emoji
